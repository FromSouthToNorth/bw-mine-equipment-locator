...
#### sensor_type 巷道偏好 (`_SENSOR_TUNNEL_PREF`,locator.py:213-224) — 命中 +2
...
- `keyword` 由 `_classify_keyword` (locator.py:593-606) 决定:
...
### 4. z 轴安装高度 (`_SENSOR_INSTALL_HEIGHT`,locator.py:304-311)
